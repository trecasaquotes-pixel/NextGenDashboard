 ...
 */
export function generateChangeSummary(changeType: string, oldData?: any, newData?: any): string {
  switch (changeType) {
    case "create":
    ...
    case "update_info":
      ...
      return changes.length > 0 ? `Updated ${changes.join(", ")}` : "Updated project information";
