...
export async function updateTemplate(
  id: string,
  data: Partial<Omit<TemplateRow, "id" | "createdAt" | "updatedAt">>,
): Promise<TemplateRow> {
...
export async function createTemplateRoom(
  templateId: string,
  data: Omit<NewTemplateRoomRow, "templateId">,
): Promise<TemplateRoomRow> {
...
export async function updateTemplateRoom(
  templateId: string,
  roomId: string,
  data: Partial<Omit<TemplateRoomRow, "id" | "templateId" | "createdAt" | "updatedAt">>,
): Promise<TemplateRoomRow> {
...
export async function createTemplateItem(
  templateId: string,
  roomId: string,
  data: Omit<NewTemplateItemRow, "templateRoomId">,
): Promise<TemplateItemRow> {
  const res = await apiRequest(
    "POST",
    `/api/admin/templates/${templateId}/rooms/${roomId}/items`,
    data,
  );
  return res.json();
}
...
export async function updateTemplateItem(
  ...
  roomId: string,
  itemId: string,
  data: Partial<Omit<TemplateItemRow, "id" | "templateRoomId" | "createdAt" | "updatedAt">>,
): Promise<TemplateItemRow> {
  const res = await apiRequest(
    "PUT",
    `/api/admin/templates/${templateId}/rooms/${roomId}/items/${itemId}`,
    data,
  );
  return res.json();
}
