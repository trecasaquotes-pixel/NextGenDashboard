...
export default function Print() {
  ...
  const markAsAcceptedMutation = useMutation({
    mutationFn: async () => {
      ...
      const currentSignoff = quotation?.signoff || {
        ...
        trecasa: {
          name: "Trecasa Design Studio – Authorized Signatory",
          title: "Trecasa Design Studio – Authorized Signatory",
          signature: "",
          signedAt: undefined,
        },
        accepted: false,
  ...
  const handleDownloadPDF = async (type: "interiors" | "false-ceiling") => {
    ...
    try {
      ...
      console.warn(
        `Server PDF generation failed (${response.status}), falling back to client-side`,
      );
      toast({
  ...
  const interiorsSubtotal =
    serverInteriorsSubtotal > 0 ? serverInteriorsSubtotal : calculatedInteriorsSubtotal;
        ...
        <div className="space-y-6">
          ...
          >
            <TabsList className="grid w-full grid-cols-2 print:hidden">
              <TabsTrigger value="interiors" data-testid="tab-print-interiors">
                Interiors
              </TabsTrigger>
              <TabsTrigger value="false-ceiling" data-testid="tab-print-false-ceiling">
                False Ceiling
              </TabsTrigger>
            </TabsList>
              ...
              >
                ...
                <div className="cover-page">
                  ...
                  <div className="cover-footer">
                    H.No. 7-31, Shop No. C2, Phase-II, JPN Nagar, Miyapur, Hyderabad
                    <br />
                ...
                <div
                  className="pdf-header bg-[#154734] text-white rounded-t-lg print:rounded-none"
                  style={{
                    minHeight: "110px",
                    padding: "16px 24px",
                ...
                <div
                  className="pdf-footer bg-white border-t border-[#C7A948] flex items-center justify-center"
                  style={{
                    height: "40px",
                    padding: "10px 0",
                    fontFamily: "'Montserrat', Arial, sans-serif",
                ...
                >
                  ...
                  <section className="summary-section" style={{ marginTop: "10px" }}>
                    <div
                      className="bg-[#154734] text-white px-3 py-1.5 font-semibold text-[11px]"
                    ...
                    <table className="summary-table w-full border-collapse text-[9.5px]">
                      ...
                      <tfoot>
                        <tr className="bg-[#FAF8F1] border-t border-[#C7A948]">
                          <td
                            className="px-3 py-2.5 text-left font-semibold text-[#154734]"
                            style={{ fontFamily: "'Montserrat', Arial, sans-serif" }}
                          >
                            Total
                          </td>
                          <td
                            className="px-3 py-2.5 text-right font-semibold text-[#154734]"
                            style={{ fontFamily: "'Montserrat', Arial, sans-serif" }}
                          >
                  ...
                  <section className="price-summary-section" style={{ marginTop: "14px" }}>
                    <div
                      className="bg-[#154734] text-[#C7A948] px-3 py-1 font-medium text-[10.5px]"
                      style={{ fontFamily: "'Montserrat', Arial, sans-serif" }}
                    >
                      Price Summary (Interiors)
                    </div>
                    <div
                      className="border border-gray-200 px-3 py-2 text-[9.5px] space-y-1.5"
                      style={{ fontFamily: "'Montserrat', Arial, sans-serif" }}
                    >
                      ...
                      {interiorsDiscountAmount > 0 && (
                        <div className="flex justify-between text-red-600">
                          <span>
                            Discount (
                            {quotation.discountType === "percent" ? `${discountValue}%` : "Fixed"}):
                          </span>
                    ...
                    <div
                      className="bg-[#F8F3D9] border-t-2 border-[#154734] border-b border-[#C7A948] px-3 py-1.5 flex justify-between text-[11.5px] font-semibold text-[#154734]"
                      style={{ fontFamily: "'Montserrat', Arial, sans-serif" }}
                    >
                  ...
                  <section className="payment-breakdown-section" style={{ marginTop: "14px" }}>
                    ...
                    <div
                      className="text-[9.5px] space-y-0.5"
                      style={{ fontFamily: "'Montserrat', Arial, sans-serif" }}
                    >
                      <div className="flex justify-between py-1">
                        <span>Token Advance – 10%</span>
                        <span className="font-medium">{formatINR(interiorsFinalTotal * 0.1)}</span>
                      </div>
                      <div className="flex justify-between py-1">
                        <span>Design Finalisation – 60%</span>
                        <span className="font-medium">{formatINR(interiorsFinalTotal * 0.6)}</span>
                      </div>
                      <div className="flex justify-between py-1">
                      ...
                      ([room, items], roomIdx) => {
                        ...
                        return (
                          <section
                            ...
                            style={{ marginTop: roomIdx === 0 ? "0" : "14px" }}
                          >
                            <h4
                              className="text-[11pt] font-semibold text-[#154734] mb-1"
                              style={{
                                lineHeight: "1.4",
                                fontFamily: "'Playfair Display', Georgia, serif",
                              }}
                            ...
                            <table
                              className="w-full border-collapse text-[8.5pt]"
                              style={{ fontFamily: "'Montserrat', Arial, sans-serif" }}
                            >
                              <thead>
                              ...
                              <tbody>
                                {items.map((item, idx) => (
                                  <tr
                                    ...
                                    style={{
                                      minHeight: "24px",
                                      borderBottom: "0.6pt solid #EAEAEA",
                                    }}
                                  >
                                    <td
                                      style={{
                            ...
                            {/* Room Subtotal Bar */}
                            <div
                              className="flex justify-between items-center text-white font-medium text-[9.5pt]"
                              style={{
                  ...
                  >
                    <h3
                      className="text-sm font-semibold text-[#154734] border-t-2 border-[#C7A948] pt-2 border-b border-gray-300 pb-1"
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                      ...
                      <div className="space-y-2 break-inside-avoid">
                        <p
                          className="text-[8px] uppercase text-gray-600 tracking-wide"
                          style={{ fontFamily: "'Montserrat', sans-serif", fontWeight: 500 }}
                        >
                          Client
                        </p>
                          ...
                          <div>
                            ...
                            <p className="text-xs">
                              {quotation.signoff?.client?.signedAt
                                ? dateFormat(quotation.signoff.client.signedAt)
                                : "_____________"}
                            </p>
                          </div>
                        </div>
                          ...
                          <div>
                            ...
                            <p className="text-xs">
                              {quotation.signoff?.trecasa?.signedAt
                                ? dateFormat(quotation.signoff.trecasa.signedAt)
                                : "_____________"}
                            </p>
                          </div>
                        </div>
                      ...
                      <section className="summary-section" style={{ marginTop: "10px" }}>
                        ...
                        <table className="summary-table w-full border-collapse text-[9.5px]">
                          ...
                          <tfoot>
                            <tr className="bg-[#FAF8F1] border-t border-[#C7A948]">
                              <td
                                className="px-2 py-2 text-left font-semibold text-[#154734]"
                                style={{ fontFamily: "'Montserrat', Arial, sans-serif" }}
                              >
                                Total
                              </td>
                              <td
                                className="px-2 py-2 text-right font-semibold text-[#154734]"
                                style={{ fontFamily: "'Montserrat', Arial, sans-serif" }}
                              >
                  ...
                  {fcRoomTotals.length > 0 && (
                    <section className="payment-breakdown-section" style={{ marginTop: "14px" }}>
                      ...
                      >
                        <div className="flex justify-between py-1">
                          <span>Token Advance – 10%</span>
                          <span className="font-medium">{formatINR(fcFinalTotal * 0.1)}</span>
                        </div>
                        <div className="flex justify-between py-1">
                          <span>Design Finalisation – 60%</span>
                          <span className="font-medium">{formatINR(fcFinalTotal * 0.6)}</span>
                        </div>
                        <div className="flex justify-between py-1">
                          <span>Mid Execution – 25%</span>
                      ...
                      <tbody>
                        ...
                        {fcDiscountAmount > 0 && (
                          <tr className="row">
                            ...
                            <td className="py-1 text-right font-mono tabular-nums text-red-600">
                              -{formatINR(fcDiscountAmount)}
                            </td>
                          </tr>
                        )}
                        <tr className="row">
                        ...
                        <tr className="final-total row border-t-2 border-[#C7A948]">
                          <td className="py-3 text-right pr-4">
                            <div
                              className="text-[8px] text-[#154734] mb-1"
                              style={{ fontFamily: "'Montserrat', sans-serif" }}
                            >
                              Final False Ceiling Quote
                            </div>
                          </td>
                          <td className="py-3 text-right">
                            ...
                            >
                              ...
                              <span className="text-[#154734]">
                                {formatINR(fcFinalTotal).replace("₹", "")}
                              </span>
                            </div>
                            <div
