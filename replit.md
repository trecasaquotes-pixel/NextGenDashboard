...
- **Template System**: Auto-creation of room items based on project categories using 4 predefined templates (Modern 1BHK, Modern 2BHK, Modern 3BHK, Commercial). Template changes propagate instantly across all pages (Scope, Estimate, Print, PDFs) through comprehensive cache invalidation and refetching.
  - **Modern 1BHK Template**: Residential template with essential interior items and false ceiling rooms
  - **Modern 2BHK Template**: Extended residential template with 2 bedrooms and additional spaces
  - **Modern 3BHK Template**: Full-featured residential template with 15 interior rooms (71 items total: Kitchen, Living Room, Dining, Master Bedroom, Bedroom 2, Bedroom 3, 3 Bathrooms, Puja Room, Utility, Foyer, 2 Balconies, Storage) and 9 false ceiling rooms
  - **Commercial Template**: Office/commercial space template with 7 interior rooms (30 items total: Reception/Lobby, Conference Room, Manager's Cabin, Office Cabins, Pantry/Cafeteria, Storage/Server Room, Restroom) and 5 false ceiling rooms
